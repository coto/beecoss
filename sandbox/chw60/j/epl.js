...
var eplArgs = { iIF:1,sV:"http://ads.us.e-planning.net/",vV:"4",sI:"8dd4",sec:seccionEplanning,eIs:arrayPosiciones,kVs:kwsEpl };
function eplCheckStart() {
	if (document.epl) {
		...
		if (!eS2) {
			...
			ss.src = 'http://ads.us.e-planning.net/egc/4/8d02';
