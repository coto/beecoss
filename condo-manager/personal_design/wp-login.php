...
<div id="login"><h1><a href="<?php echo get_blog_option( BP_ROOT_BLOG, 'siteurl');/*coto*/ ?>" title="<?php echo apply_filters('login_headertitle', $current_site->site_name ); ?>"><span class="hide"><?php bloginfo('name'); ?></span></a></h1>
<?php
