...
_routes = [
    ...
    RedirectRoute('/admin/', users.AdminGeoChartHandler, name='admin-geochart', strict_slash=True),
    RedirectRoute('/admin/users/', users.AdminUserListHandler, name='admin-user-list', strict_slash=True),
