...
namespace DCE05.Ejemplos.EstrellaUno.ReglasNegocio {
    ...
    /// <summary>
    /// Representa el cat�logo de ventas del sistema.
    /// Permite administrar la l�gica de negocios asociada a las ventas.
    /// </summary>
    public class CatalogoVentas {
        ...
        /// <summary>
        /// Obtiene los �tems de una venta.
        /// </summary>
        /// <param name="venta">La venta cuyos �tems se van a obtener.</param>
        /// <returns>Los �tems de la venta.</returns>
        /// <exception cref="ReglasNegocioException">Si ocurre un error de negocio.</exception>
        private List<ItemVenta> ObtenerItemsVenta(Venta venta) {
            ...
            try {
                ...
                throw new ReglasNegocioException("Error al acceder a la base de datos para obtener los �tems de venta.");
            } catch (ReglasNegocioException ex) {
                throw new ReglasNegocioException("Error a obtener los �tems de venta. " + ex.Message);
            }
            return items;
        }

        /// <summary>
        /// Confirma una venta registrando sus �tems en el sistema.
        ...
        public void ConfirmarVenta(Venta venta) {
            if (venta.Items.Count.Equals(0)) {
                throw new ReglasNegocioException("La venta no contiene ning�n �tem.");
            }
        ...
        /// <summary>
        /// Cancela las ventas pendientes (iniciadas pero que no poseen �tems).
        /// </summary>
        /// <exception cref="ReglasNegocioException">Si ocurre un error de negocio.</exception>
        public void CancelarVentasPendientes() {
            ...
            try {
                ...
                throw new ReglasNegocioException("Error al cancelar las ventas vac�as.", ex);
            }
