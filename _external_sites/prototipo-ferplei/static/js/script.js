...
$(document).ready(function() {
    ...
    /***** Elige tipo de visualización entre lista y mashup  ****/
    $('body').on('click', '[data-change-view]', function ( e ) {
        var $this = $(this), href
            , target = $this.attr('data-change-view')
                || e.preventDefault()
                || (href = $this.attr('href')) && href.replace(/.*(?=#[^\s]+$)/, '') //strip for ie7
            , option = $(target).data('collapse') ? 'toggle' : $this.data()
        insertParam("view", target)
    ...
    /* cambia definición css para para boton collapse de menu ver más en móviles */
